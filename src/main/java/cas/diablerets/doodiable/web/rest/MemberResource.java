...
import cas.diablerets.doodiable.web.rest.util.HeaderUtil;
import cas.diablerets.doodiable.web.rest.util.PaginationUtil;
...
public class MemberResource {
    ...
    @RequestMapping(value = "/_search/members/{query}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<Member> search(@PathVariable String query) {
        return StreamSupport
            .stream(memberSearchRepository.search(queryString(query)).spliterator(), false)
